...
@     @ INDIVIDUAL - SP
@     mov     r2, r0                  @ r2 gets process table address
@     mov     r0, sp
@ vesp_saida:
@     nop
@     mov     r0, r2                  @ r0 gets process table address

@     @ END INDIVIDUAL - SP
    msr     cpsr, r1

@     @ INDIVIDUAL - PROCESS TABLE
@     mov     r1, r0                  @ r1 gets process table address
@     ldr     r0, =linhaA
@ ve_linhaA:
@     nop
@     ldr     r0, =linhaB
@ ve_linhaB:
@     nop
@     mov     r0, r1                  @ r0 gets process table address
@     @ END INDIVIDUAL - PROCESS TABLE
